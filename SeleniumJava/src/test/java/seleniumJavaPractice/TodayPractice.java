...
public class TodayPractice {
	...
	public void setUp() throws InterruptedException {
		...
		List<WebElement> findIphone = driver.findElements(By.xpath("//span[contains(text(),'Apple iPhone 13 ')]"));
		for (int i = 0; i < findIphone.size(); i++) {
			String text = findIphone.get(i).getText();
			System.out.println(text);
			/*
			 * findIphone.get(5).click(); String valueof5 = findIphone.get(5).getText();
			 * System.out.println("this is Ipone no 5: "+valueof5); break;
			 */
